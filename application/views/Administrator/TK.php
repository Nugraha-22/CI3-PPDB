  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-body">
      	<?php echo form_open_multipart('Administrator/TK/Add') ?>
...
<div class="modal fade bd-example-modal-lg" id="update<?= $t['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-body">
      	<?php echo form_open_multipart('Administrator/TK/Update') ?>
				<section class="contact-us">
					<div class="container">
						<div class="row">
							<div class="contact-form col-md-12">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="<?= base_url('Administrator/TK/Delete/'.$t['id']) ?>" class="btn btn-primary">Delete</a>
      </div>
    </div>
  </div>
</div>

				...
				<section class="contact-us">
					<div class="container">
						<div class="row">
							...
							<!-- /section title -->
							<?= form_open_multipart('User/TPQ/Add'); ?>
							...
							<div class="title text-center" >
								...
								<div class="border"></div>
								  ...
								  <div class="form-row">
								    ...
								    <div class="form-group col-md-4">
								    <label>NIK</label>
								      <input type="text" name="nik_ayah" class="form-control" value="<?php echo set_value('
								      nik_ayah'); ?>" placeholder="Masukan Nomor Induk Keluarga">

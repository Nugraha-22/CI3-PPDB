    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav ml-auto text-center">
          <li class="nav-item ">
            <a class="nav-link" href="<?= base_url('Administrator/Beranda') ?>">Beranda</a>
          </li>
          <li class="nav-item ">
            <a class="nav-link" href="<?= base_url('Administrator/Akun') ?>">Akun</a>
          </li>
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?= base_url('Administrator/Banner') ?>">Banner</a>
              <a class="dropdown-item" href="<?= base_url('Administrator/Fasilitas') ?>">Fasilitas</a>
              <a class="dropdown-item" href="<?= base_url('Administrator/Kegiatan') ?>">Kegiatan</a>
              <a class="dropdown-item" href="<?= base_url('Administrator/StrukturOrganisasi') ?>">Struktur Organisasi</a>
              <a class="dropdown-item" href="<?= base_url('Administrator/VisiMisi') ?>">Visi & Misi</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="<?= base_url('Administrator/Les') ?>">Les</a>
              <a class="dropdown-item" href="<?= base_url('Administrator/TK') ?>">TK</a>
              <a class="dropdown-item" href="<?= base_url('Administrator/TPQ') ?>">TPQ</a>
            </div>
          </li>
          <li class="nav-item ">

	...
	<div class="container">
		<div class="row">
			...
			<div class="contact-form col-md-6 " >
				...
				<?php echo form_open('Sistem-Informasi/Auth'); ?>
					<div class="form-group">
						<input type="email" placeholder="Email" class="form-control" name="email" value="<?= set_value('email'); ?>">
					...
					<br>
					Belum Punya Akun??
					<a href="<?php echo base_url('Sistem-Informasi/DaftarAkun'); ?>">Daftar Disini</a>						
